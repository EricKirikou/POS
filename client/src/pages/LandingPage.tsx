...
export default function LandingPage() {
  ...
  return <main className="landing-page">
    <nav className="landing-nav">
      <button className="landing-brand" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })} aria-label="TradeCore home"><img src="/manus-storage/tradecore-logo-mark_69c7bf77.png" alt="" /><span><b>Trade</b><em>Core</em></span></button>
    ...
    <footer className="landing-footer"><div className="landing-brand"><img src="/manus-storage/tradecore-logo-mark_69c7bf77.png" alt="" /><span><b>Trade</b><em>Core</em></span></div><span>Retail operations, in balance.</span><span>© 2026 TradeCore Retail Systems</span></footer>
  </main>;
}
